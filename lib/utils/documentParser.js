...
class DocumentParser {
  ...
  static finalizeAnnouncement(announcement) {
    ...
    const content = announcement.rawContent.join(' ').trim();
    
    // Keep the title in the content - no removal of title from content
  ...
  static extractTitle(text) {
    const patterns = [
     ...
     { regex: /infant\s+baptism.*registrations?|registrations?.*infant\s+baptism/i, title: "Infant Baptism Registration" },
     { regex: /liturgical.*training/i, title: "Liturgy Group Training" },
