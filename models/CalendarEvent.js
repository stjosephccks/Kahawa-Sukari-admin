...
const CalendarEventSchema = new Schema({
    ...
    group: { 
        type: String, 
        required: true,
        enum: ['ALL','St. JohnPaul || Outstation','PMC','YCA','MYM','Mantle','Charistmatic','Liturgical Group','CL','Carovana','Emanuela Mazzola','St.Joseph Hospital', 'Choir',  'CWA', 'CMA', 'Parish Council', 'Other']
    },
    description: String
}, {
    timestamps: true
